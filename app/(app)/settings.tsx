...
export default function SettingsScreen() {
  ...
  const handleLogout = () => {
    Alert.alert("Logout", "Are you sure you want to logout?", [
      ...
      {
        text: "Logout",
        onPress: () => router.push("../app"), // Asumsi rute login ada di root
        style: "destructive",
      },
    ]);
  };
          ...
          {(["email", "push", "sms"] as const).map((type, i) => (
            <View
              ...
              className={`flex-row justify-between items-center py-3 ${
                i !== 2 ? "border-b border-gray-200 dark:border-gray-700" : ""
              }`}
            >
              <Text
                className={`${
            ...
            >
              ...
              <View className="flex-row">
                ...
                <View className="flex-row items-center">
                  ...
                  {/* Ikon carry-over sepertinya lebih cocok 'MapPin', 
                      tapi jika ingin ganti bisa pakai 'Archive' atau 'Repeat' 
                      Saya biarkan 'MapPin' sesuai kode asli Anda
                  */}
                  <MapPin
                    color={isDarkMode ? "#9CA3AF" : "#6B7280"}
                    size={14}
